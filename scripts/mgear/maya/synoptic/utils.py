...
class IkFkTransfer(AbstractAnimationTransfer):
    ...
    def setCtrls(self, fks, ik, upv, ikRot=None):
    ...
    @staticmethod
    def showUI(model, ikfk_attr, uihost, fks, ik, upv, ikRot=None, *args):
    ...
    @staticmethod
    def toIK(model, ikfk_attr, uihost, fks, ik, upv, ikRot=None, **kwargs):
        # type: (pm.nodetypes.Transform, str, str,
        # List[str], str, str, **str) -> None
    ...
    @staticmethod
    def toFK(model, ikfk_attr, uihost, fks, ik, upv, ikRot=None, **kwargs):
        # type: (pm.nodetypes.Transform, str, str,
        # List[str], str, str, **str) -> None
